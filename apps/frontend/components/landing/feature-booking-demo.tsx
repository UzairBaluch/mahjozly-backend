...
// Tiny scripted demo: highlights a date → picks a slot → shows confirmation, in a loop.
  ...
  return (
    <div className="rounded-xl border border-[color:var(--color-mist)] bg-[color:var(--color-paper)] p-5 shadow-sm">
      ...
      {phase !== 'confirmed' ? (
                  ...
                  <div
                    ...
                    className={
                      ...
                      (isSelected
                        ...
                        : enabled
                        ? 'border-[color:var(--color-mist)] text-[color:var(--color-ink)] hover:border-[color:var(--color-thread)]'
        ...
        <div className="anim-fade-up flex flex-col items-center justify-center py-6 text-center">
